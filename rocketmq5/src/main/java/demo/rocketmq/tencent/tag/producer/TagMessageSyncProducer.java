...
package demo.rocketmq.tencent.tag.producer;
...
public class TagMessageSyncProducer {
    private static final Logger log = LoggerFactory.getLogger(TagMessageSyncProducer.class);

    private TagMessageSyncProducer() {
    }
