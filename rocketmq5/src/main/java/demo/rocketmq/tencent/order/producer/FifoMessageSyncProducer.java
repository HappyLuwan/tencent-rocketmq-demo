...
public class FifoMessageSyncProducer {
    private static final Logger log = LoggerFactory.getLogger(FifoMessageSyncProducer.class);

    private FifoMessageSyncProducer() {
    }
