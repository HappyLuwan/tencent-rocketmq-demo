...
package demo.rocketmq.tencent.delay.producer;
...
public class DelayMessageSyncProducer {
    private static final Logger log = LoggerFactory.getLogger(DelayMessageSyncProducer.class);

    private DelayMessageSyncProducer() {
    }
    ...
    public static void main(String[] args) throws ClientException, IOException {
        ...
        //设置延迟时间为12秒
        Duration messageDelayTime = Duration.ofSeconds(12);
